---
name: kapable:promote-beta-to-stable
...
Promote the latest pre-release of AkshatSidharth/KapAble to a stable release.
...
1. **Look up the latest pre-release:**
   ...
   ```
   gh release list --repo AkshatSidharth/KapAble --limit 10 --json tagName,isPrerelease
   ```
...
7. **Push the branch to upstream (AkshatSidharth/KapAble):**
