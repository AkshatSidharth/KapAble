# Why KapAble uses state machines
...
In KapAble, a machine is a plain TypeScript function. No library:
...
const handleConnect = async () => {
  ...
  await ipc.system.openExternalUrl("https://oauth.kapable.sh/.../neon/login");
