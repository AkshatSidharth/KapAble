...
<kapable-write path="src/pages/Index.tsx" description="Home page">
const Index = () => {
  return (
...
<kapable-write path="src/pages/ManualOnly.tsx" description="Manual route page">
const ManualOnly = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="text-center">
...
<kapable-write path="src/App.tsx" description="App with routes declared in an object array">
