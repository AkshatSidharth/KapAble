...
<kapable-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
<kapable-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<kapable-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<kapable-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<kapable-security-finding title="JWT Secret Using Default Value" level="high">
...
<kapable-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<kapable-security-finding title="Missing Security Headers" level="low">
