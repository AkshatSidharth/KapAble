...
- Sub-agent protocol stability: `kapable/value` now gets exactly one tool step, no provider retries,
...
- Targeted baseline-winner hill climb:
  ...
  - Generated/story/codegen/docs/mocks paths are now excluded from coverage claims, route classification
    ...
    A KapAble Pro rerun (`run-2026-06-07T04-29-44-888Z`) hit the account budget and exposed a runner
