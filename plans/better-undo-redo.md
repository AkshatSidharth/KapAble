...
- Distinguishing KapAble-authored checkpoint commits from user commits in the dialog copy (e.g. a subtle badge) — trigger logic treats all extras alike per discussion, but labeling could reduce alarm for checkpoint-only cases.
