...
(four in `PreviewIframe.tsx`, including `kapable-app`-sourced cloud-sandbox
...
in production**. KapAble updates via `update-electron-app`/Squirrel
...
- Networked/multi-instance KapAble; hot-moving live actors between processes.
