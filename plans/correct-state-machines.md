...
Expected denial remains a `KapableError` with its original `KapableErrorKind`
...
- Preserve `KapableErrorKind`; do not hide dependency/programming failures as
  denial.
