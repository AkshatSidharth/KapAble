...
export GITHUB_WORKSPACE="$RUNNER_DIR/_work/kapable/kapable"
...
touch -t 202001010000 "$RUNNER_DIR/_work/kapable"
...
grep -q "Keeping active _work dir: $RUNNER_DIR/_work/kapable" "$TEST_ROOT/output.log"
