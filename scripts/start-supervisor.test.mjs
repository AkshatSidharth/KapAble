...
test("finds detached Crashpad processes for this checkout", () => {
  const stdout = `
  200  50 ${crashpadExecutable} --database=kapable
  201  50 ${crashpadExecutable}
  300  99 ${repoRoot}-zero/node_modules/electron/dist/Electron.app/Contents/Frameworks/Electron Framework.framework/Helpers/chrome_crashpad_handler --database=kapable-zero
`;
