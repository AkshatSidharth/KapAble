...
/**
 * The last look at credentials KapAble is about to forget.
 *
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent data-testid="coolify-sign-out-dialog">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            KapAble will forget the details below. Your server keeps running and
            your apps keep their settings.
            {credentials?.server?.password
              ? " KapAble made this password up and is the only thing holding it — Coolify cannot show it to you again."
              : ""}
          </AlertDialogDescription>
        </AlertDialogHeader>
