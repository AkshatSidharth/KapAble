...
interface KapableAppMediaFolderProps {
  appName: string;
  appId: number;
  appPath: string;
  files: MediaFile[];
...
export function KapableAppMediaFolder({
  appName,
  appId,
  appPath,
  files,
  ...
  if (isOpen) {
    return (
      <>
        ...
        {previewFile && (
          <ImageLightbox
            imageUrl={buildKapableMediaUrl(appPath, previewFile.fileName)}
            alt={previewFile.fileName}
            filePath={`${appPath}/.kapable/media/${previewFile.fileName}`}
