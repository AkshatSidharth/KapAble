...
interface KapableProTrialDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
export function KapableProTrialDialog({
  isOpen,
  onClose,
  utmCampaign = "setup-dialog-v2",
}: KapableProTrialDialogProps) {
  const utmParams = `utm_source=kapable-app&utm_medium=app&utm_campaign=${encodeURIComponent(utmCampaign)}`;
