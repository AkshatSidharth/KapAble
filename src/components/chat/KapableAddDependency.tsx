...
interface KapableAddDependencyProps {
  children?: ReactNode;
  node?: any;
  packages?: string;
}

export const KapableAddDependency: React.FC<KapableAddDependencyProps> = ({
  children,
  node,
}) => {
  ...
  return (
    ...
    >
      <KapableCardHeader icon={<Package size={15} />} accentColor="blue">
        <KapableBadge color="blue">Add Packages</KapableBadge>
        {hasChildren && (
