...
interface KapableAddIntegrationProps {
  children: React.ReactNode;
  provider?: "neon" | "supabase";
  outcome?: "pending" | "skipped" | "completed" | "dismissed";
}

export const KapableAddIntegration: React.FC<KapableAddIntegrationProps> = ({
  children,
  ...
  if (outcome === "skipped") {
    return (
      <KapableCard accentColor="slate" state="finished">
        <KapableCardHeader icon={<Database size={15} />} accentColor="slate">
          <KapableBadge color="slate">
  ...
  return (
    <KapableCard accentColor="blue">
      <KapableCardHeader icon={<Database size={15} />} accentColor="blue">
