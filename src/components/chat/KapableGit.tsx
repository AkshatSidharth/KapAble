...
interface KapableGitProperties {
  operation?: string;
  revision?: string;
  path?: string;
  scope?: string;
...
interface KapableGitProps {
  children?: ReactNode;
  node?: { properties?: KapableGitProperties };
}
...
export const KapableGit = ({ children, node }: KapableGitProps) => {
