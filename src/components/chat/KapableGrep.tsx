...
export const KapableGrep: React.FC<KapableGrepProps> = ({ children, node }) => {
  ...
  return (
    <KapableCard
      ...
      data-testid="kapable-grep"
    >
      <KapableCardHeader icon={<Search size={15} />} accentColor="violet">
        <KapableBadge color="violet">GREP</KapableBadge>
