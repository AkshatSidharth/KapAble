...
interface KapableMcpToolSchemaProps {
  children?: ReactNode;
  node?: {
...
export const KapableMcpToolSchema: React.FC<KapableMcpToolSchemaProps> = ({
  children,
  node,
}) => {
  ...
  return (
    ...
    >
      <KapableCardHeader icon={<ScrollText size={15} />} accentColor="indigo">
        <KapableBadge color="indigo">MCP Tool Schema</KapableBadge>
        {!isExpanded && tools && (
