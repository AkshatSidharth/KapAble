...
interface KapableOutputProps {
  type: "error" | "warning";
  message?: string;
  children?: React.ReactNode;
}

export const KapableOutput: React.FC<KapableOutputProps> = ({
  type,
  message,
  children,
}) => {
  ...
  return (
    ...
    >
      <KapableCardHeader icon={icon} accentColor={accentColor}>
        <KapableBadge color={accentColor}>{label}</KapableBadge>
        {message && (
