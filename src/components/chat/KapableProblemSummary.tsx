...
interface KapableProblemSummaryProps {
  summary?: string;
...
export const KapableProblemSummary: React.FC<KapableProblemSummaryProps> = ({
  summary,
  children,
}) => {
  ...
  return (
    ...
    >
      <KapableCardHeader icon={<AlertTriangle size={15} />} accentColor="amber">
        <KapableBadge color="amber">Auto-fix</KapableBadge>
