...
export const KapableScript: React.FC<KapableScriptProps> = ({
  ...
  return (
    <KapableCard
      ...
      data-testid="kapable-script-card"
    >
      <KapableCardHeader icon={<ScrollText size={15} />} accentColor="amber">
        <KapableBadge color="amber">Script</KapableBadge>
