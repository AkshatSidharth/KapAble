...
interface KapableSearchReplaceProps {
  children?: ReactNode;
  node?: any;
  path?: string;
  description?: string;
...
export const KapableSearchReplace: React.FC<KapableSearchReplaceProps> = ({
  children,
  node,
  path: pathProp,
  ...
  return (
    <KapableCard
      ...
      data-testid="kapable-search-replace"
    >
      <KapableCardHeader icon={<Search size={15} />} accentColor="violet">
        <KapableBadge color="violet">Search & Replace</KapableBadge>
        {fileName && (
