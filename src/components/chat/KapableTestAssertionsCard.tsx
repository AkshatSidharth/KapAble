...
/**
 * The `<kapable-test-assertions>` tag as it appears in the transcript: a receipt,
 * not a control.
 *
...
interface KapableTestAssertionsCardProps {
  node: {
    properties: {
      "proposal-id"?: string;
      "request-id"?: string;
...
function ReceiptShell({ children }: { children: React.ReactNode }) {
  return (
    <div
      ...
      data-testid="kapable-test-assertions-receipt"
    >
    ...
    return (
      <ReceiptShell>
        ...
        <span
          ...
          data-testid="kapable-test-assertions-approved-badge"
        >
