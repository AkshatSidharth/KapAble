...
import { KapableTokenSavings } from "./KapableTokenSavings";

interface KapableThinkProps {
  node?: any;
...
export const KapableThink: React.FC<KapableThinkProps> = ({ children, node }) => {
  ...
  const tokenSavingsMatch =
    typeof children === "string"
      ? children.match(
          /^kapable-token-savings\?original-tokens=([0-9.]+)&smart-context-tokens=([0-9.]+)$/,
        )
      : null;
  ...
  // If it's token savings format, render KapableTokenSavings component
