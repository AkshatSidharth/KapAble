...
import { KapableCard, KapableCardHeader } from "./KapableCardPrimitives";

interface KapableTokenSavingsProps {
  originalTokens: number;
  smartContextTokens: number;
}

export const KapableTokenSavings: React.FC<KapableTokenSavingsProps> = ({
  originalTokens,
  smartContextTokens,
}) => {
  ...
  return (
    <Tooltip>
      <TooltipTrigger>
        <KapableCard accentColor="green">
          <KapableCardHeader icon={<Zap size={15} />} accentColor="green">
