 ...
 * `<kapable-test-assertions>` tag), but a plan waiting on a decision belongs with
 ...
 * itself keeps only a receipt of what was decided (`KapableTestAssertionsCard`).
 *
...
export function TestAssertionsPlanCard({
  ...
  const requestVerificationRun = (generatedSpecPath: string) => {
    ...
    streamMessage({
      prompt: [
        `I approved the assertions. KapAble generated ${generatedSpecPath} from my recording.`,
        "",
  ...
  return (
    <div
      ...
      data-testid="kapable-test-assertions-card"
    >
      <button
        type="button"
      ...
      >
        ...
        <span
          ...
          data-testid={
            isApproved && !isBusy
              ? "kapable-test-assertions-approved-badge"
              : undefined
          }
        >
        ...
        >
          {items.map((item, index) => {
            ...
            if (item.kind === "step") {
              return (
                <li
                  ...
                  data-testid={`kapable-test-assertions-step-${item.stepIndex}`}
            ...
            return (
              <li
                key={item.id}
                data-testid={`kapable-test-assertions-assertion-${item.id}`}
                  ...
                  <div className="min-w-0 flex-1">
                    {isEditing ? (
                      <textarea
                        ...
                        data-testid={`kapable-test-assertions-edit-${item.id}`}
                      ...
                      <button
                        ...
                        data-testid={`kapable-test-assertions-text-${item.id}`}
                        className={cn(
                  ...
                  {!isLocked && !isEditing && (
                    <>
                      ...
                      <button
                        ...
                        title="Remove"
                        data-testid={`kapable-test-assertions-remove-${item.id}`}
                        className={cn(
                          ICON_BUTTON,
                          ROW_ACTION,
      ...
      <div className="flex flex-wrap items-center gap-2 border-t border-border/50 px-3 py-1.5">
        {isApproving ? (
          ...
          <span
            ...
            data-testid="kapable-test-assertions-generating-note"
          >
            <Loader2 size={12} className="animate-spin motion-reduce:hidden" />
          ...
          <span
            className="inline-flex items-center gap-1.5 text-xs text-muted-foreground"
            data-testid="kapable-test-assertions-closing-note"
          >
            <Loader2 size={12} className="animate-spin motion-reduce:hidden" />
            Closing the plan…
          </span>
          ...
          <>
            ...
            <button
              ...
              disabled={!specPath}
              data-testid="kapable-test-assertions-open-file-button"
          ...
          <span
            ...
            data-testid="kapable-test-assertions-discarded-note"
          >
          ...
          <>
            <span className="text-xs text-muted-foreground">
              {hasBlankAssertion
                ...
                : isAgentWaiting
                  ? "KapAble is waiting on this before it continues."
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <button
                ...
                disabled={isBusy}
                data-testid="kapable-test-assertions-discard-button"
              ...
              <button
                ...
                data-testid="kapable-test-assertions-approve-button"
