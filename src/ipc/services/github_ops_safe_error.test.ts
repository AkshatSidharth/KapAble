...
describe("safeGithubOpsErrorMessage", () => {
  ...
  it.each([
    ...
    [
      "fatal: unable to create /Users/John Smith/kapable-apps/demo/.git/index.lock",
      "fatal: unable to create [redacted path] … [path remainder redacted]",
    ],
    [
      String.raw`fatal: unable to create C:\Users\John Smith\kapable-apps\demo\.git\index.lock`,
      "fatal: unable to create [redacted path] … [path remainder redacted]",
    ],
    [
    ...
    [
      String.raw`fatal: unable to read C:\Users\John Smith\kapable-apps\demo\src\App.tsx`,
    ...
    [
      "fatal: repository 'file:///Users/alice/kapable-apps/demo' does not exist",
    ...
    [
      "hook: KAPABLE_PUBLIC_GIT_DOCUMENTATION_URL_7",
      "hook: KAPABLE_PUBLIC_GIT_DOCUMENTATION_URL_7",
    ],
    [
