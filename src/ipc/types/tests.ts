...
/**
 * The app-relative directory where KapAble keeps a user app's Playwright E2E
...
/**
 * The directory KapAble used for E2E specs before `E2E_TEST_DIR`. Existing apps may
