 ...
 * production DB. Local development doesn't pull from Vercel, and KapAble apps
...
export function canonicalOrigin(value: string): string | null {
  ...
  // but KapAble's local preview genuinely runs over HTTP. Preserve that scheme for
