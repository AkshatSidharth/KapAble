...
describe("parseFilesFromMessage", () => {
  describe("kapable-read tags", () => {
    ...
    it("should parse multiple kapable-read tags", () => {
      const input = `
        <kapable-read path="src/components/Button.tsx"></kapable-read>
        <kapable-read path="src/utils/helpers.ts"></kapable-read>
        <kapable-read path="src/styles/main.css"></kapable-read>
      `;
      const result = parseFilesFromMessage(input);
    ...
    it("should trim whitespace from file paths in kapable-read tags", () => {
      const input =
        '<kapable-read path="  src/components/Button.tsx  "></kapable-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    ...
    it("should skip empty path attributes", () => {
      const input = `
        <kapable-read path="src/components/Button.tsx"></kapable-read>
        <kapable-read path=""></kapable-read>
        <kapable-read path="src/utils/helpers.ts"></kapable-read>
      `;
      const result = parseFilesFromMessage(input);
      expect(result).toEqual([
    ...
    it("should handle file paths with special characters", () => {
      const input =
        '<kapable-read path="src/components/@special/Button-v2.tsx"></kapable-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/@special/Button-v2.tsx"]);
    });
  });

  describe("kapable-code-search-result tags", () => {
    it("should parse a single file from kapable-code-search-result", () => {
      const input = `<kapable-code-search-result>
src/components/Button.tsx
    ...
    it("should parse multiple files from kapable-code-search-result", () => {
      const input = `<kapable-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should skip empty lines in kapable-code-search-result", () => {
      const input = `<kapable-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should handle multiple kapable-code-search-result tags", () => {
      const input = `<kapable-code-search-result>
src/components/Button.tsx
src/components/Input.tsx
</kapable-code-search-result>
...
src/styles/main.css
  ...
  describe("mixed tags", () => {
    it("should parse both kapable-read and kapable-code-search-result tags", () => {
      const input = `
<kapable-read path="src/config/app.ts"></kapable-read>
...
<kapable-read path="src/components/Header.tsx"></kapable-read>
...
<kapable-read path="src/config/site.ts"></kapable-read>
...
`;
  ...
  describe("edge cases", () => {
    ...
    it("should handle malformed tags gracefully", () => {
      const input = `
<kapable-read path="src/file1.ts"
<kapable-code-search-result>
src/file2.ts
`;
      const result = parseFilesFromMessage(input);
    ...
    it("should handle nested angle brackets in file paths", () => {
      const input =
        '<kapable-read path="src/components/Generic<T>.tsx"></kapable-read>';
      const result = parseFilesFromMessage(input);
...
SRC/COMPONENTS/BUTTON.TSX
    ...
    it("should handle very long file paths", () => {
      ...
      const input = `<kapable-read path="${longPath}"></kapable-read>`;
      const result = parseFilesFromMessage(input);
...
describe("processChatMessagesWithVersionedFiles", () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'I found this file: <kapable-read path="src/old.ts"></kapable-read>',
          providerOptions: {
            "kapable-engine": {
      ...
      const chatMessages: ModelMessage[] = [
        {
          ...
          content: [
            {
              type: "text",
              text: 'Here is the file: <kapable-read path="src/array.ts"></kapable-read>',
            },
            {
              type: "text",
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "user",
          content:
            'Check this: <kapable-read path="src/user-file.ts"></kapable-read>',
        },
      ];
      const appPath = "/test/app";
    ...
    it("should skip assistant messages without sourceCommitHash", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        ...
        },
        {
          role: "assistant",
          content:
            'Another file: <kapable-read path="src/no-commit2.ts"></kapable-read>',
          providerOptions: {
            // kapable-engine not set
          },
        },
      ];
      const appPath = "/test/app";
  ...
  describe("parsing multiple file paths", () => {
    it("should process multiple files from kapable-code-search-result", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `<kapable-code-search-result>
src/file1.ts
src/file2.ts
</kapable-code-search-result>`,
          providerOptions: {
    ...
    it("should process mixed kapable-read and kapable-code-search-result tags", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `
<kapable-read path="src/file1.ts"></kapable-read>
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'Missing file: <kapable-read path="src/missing.ts"></kapable-read>',
          providerOptions: {
            "kapable-engine": {
              sourceCommitHash: "commit1",
            },
    ...
    it("should process multiple messages with different commits", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        ...
        },
        {
          role: "assistant",
          content:
            'Here it is again: <kapable-read path="src/file1.ts"></kapable-read>',
          providerOptions: {
            "kapable-engine": {
