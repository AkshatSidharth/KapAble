...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  },
  {
    ...
    label: "Node Runtime",
    description: "Choose between system Node.js and KapAble-managed Node.js",
  ...
  // Experiments
  {
    ...
    description:
      "In Agent mode, use a fast model to judge each MCP tool call and skip the consent prompt for safe ones. Risky actions still require approval. Requires KapAble Pro",
    keywords: [
      "mcp",
      "consent",
      "approve",
