...
describe("generateTestUserFixtureSource", () => {
  it("generates a Better Auth (Neon) sign-in helper", () => {
    ...
    expect(source).toContain("process.env.KAPABLE_TEST_USER_EMAIL");
    expect(source).toContain("process.env.KAPABLE_TEST_USER_PASSWORD");
    ...
    expect(source).toContain("process.env.KAPABLE_TEST_BASE_URL");
    ...
    expect(source).not.toContain("KAPABLE_TEST_SUPABASE_ANON_KEY");
  });
  ...
  it("generates a Supabase password-grant sign-in helper", () => {
    ...
    expect(source).toContain("process.env.KAPABLE_TEST_SUPABASE_URL");
    expect(source).toContain("process.env.KAPABLE_TEST_SUPABASE_ANON_KEY");
  ...
  it("reports a user-authored fixture as not KapAble-generated", () => {
