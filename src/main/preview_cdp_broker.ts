...
const PREVIEW_PAGE_SESSION_ID = "kapable-preview-page";
const PREVIEW_BROWSER_CONTEXT_ID = "kapable-preview-context";
const PREVIEW_BROWSER_TARGET_ID = "kapable-preview-browser";
 ...
 * commands that could enumerate or attach to KapAble's other WebContents.
 */
  ...
  private async routeBrowserCommand(
    ...
    if (request.method === "Browser.getVersion") {
      ...
      return {
        ...
        userAgent: version.userAgent ?? "KapablePreview",
