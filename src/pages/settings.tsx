      ...
      <div className="mx-auto max-w-5xl px-6 py-8 md:px-10">
        ...
        <div>
          ...
          <SettingsSection
            ...
            description="Connect the AI providers KapAble uses to build and run your apps."
          >
          ...
          <SettingsSection
            ...
            title="Telemetry"
            description="Anonymous usage data that helps improve KapAble."
          >
          ...
          <SettingsSection
            ...
            title="Integrations"
            description="Link KapAble to the services you deploy and store data with."
          >
...
export function GeneralSettings({ appVersion }: { appVersion: string | null }) {
  ...
  return (
    <SettingsSection
      ...
      title="General"
      description="Appearance, language, and how KapAble runs on your machine."
    >
...
export function WorkflowSettings() {
  return (
    <SettingsSection
      ...
      title="Workflow"
      description="How KapAble handles code changes, previews, and notifications."
    >
