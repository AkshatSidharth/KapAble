...
> = {
  ...
  buildXml: (args, isComplete) => {
    ...
    return `<kapable-app-blueprint app-name="${appName}" template="${template}" theme="${theme}" design-direction="${designDirection}" primary-color="${primaryColor}" complete="${isComplete}"></kapable-app-blueprint>`;
  },
