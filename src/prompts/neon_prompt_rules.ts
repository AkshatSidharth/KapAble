...
export const NEON_NO_MANUAL_MIGRATIONS_RULE =
  "- **no-manual-migrations**: NEVER write SQL migration files manually. Always use the execute SQL tool (`<kapable-execute-sql>`) to run schema changes against the Neon database.";
