...
### Integrating with KapAble (stdio MCP)
...
### Integrating with KapAble (HTTP MCP)
...
the KapAble MCP OAuth flow against a deterministic target rather than a
...
#### Wiring into KapAble (manual test)
